...
#define __COMMON_PXA_REGS_H

#ifndef __COMMON_HARDWARE_H
#include "common/include/hardware.h" 
#endif
...
#define _PCMCIA(Nb)	        	/* PCMCIA [0..1]                   */             	(0x20000000 + (Nb)*PCMCIASp)
#define _PCMCIAIO(Nb)	_PCMCIA (Nb)	/* PCMCIA I/O [0..1]               */
#define _PCMCIAAttr(Nb)	        	/* PCMCIA Attribute [0..1]         */          	(_PCMCIA (Nb) + 2*PCMCIAPrtSp)
#define _PCMCIAMem(Nb)	        	/* PCMCIA Memory [0..1]            */          	(_PCMCIA (Nb) + 3*PCMCIAPrtSp)
...
#define FCR_TIL     (1 << 3)    /* Transmiter interrupt Level */
...
#define OSMR6		__REG(0x40A00088)  /* */
#define OSMR7		__REG(0x40A0008C)  /* */
#define OSMR8		__REG(0x40A00090)  /* */
#define OSMR9		__REG(0x40A00094)  /* */
#define OSMR10  	__REG(0x40A00098)  /* */
#define OSMR11  	__REG(0x40A0009C)  /* */

#define OSCR		__REG(0x40A00010)  /* OS Timer Counter Register */
#define OSCR0		OSCR               /* OS Timer Counter Register */
#define OSCR4		__REG(0x40A00040) 
#define OSCR5		__REG(0x40A00044)  
#define OSCR6		__REG(0x40A00048)  
#define OSCR7		__REG(0x40A0004C)  
#define OSCR8		__REG(0x40A00050) 
#define OSCR9		__REG(0x40A00054) 
#define OSCR10  	__REG(0x40A00058)  
#define OSCR11		__REG(0x40A0005C)  


#define OMCR4		__REG(0x40A000C0)  
#define OMCR5		__REG(0x40A000C4) 
#define OMCR6		__REG(0x40A000C8) 
#define OMCR7		__REG(0x40A000CC) 
#define OMCR8		__REG(0x40A000D0)  
#define OMCR9		__REG(0x40A000D4) 
#define OMCR10   	__REG(0x40A000D8)  
#define OMCR11   	__REG(0x40A000DC) 
...
#define OSSR_RESERVED_BITS (0xFFFFF000)
...
#define OIER_E4		(0x1 << 4)
#define OIER_E5		(0x1 << 5)
#define OIER_E6		(0x1 << 6)
#define OIER_E7		(0x1 << 7)
#define OIER_E8		(0x1 << 8)
#define OIER_E9		(0x1 << 9)
#define OIER_E10	(0x1 << 10)
#define OIER_E11	(0x1 << 11)

#define OIER_RESERVED_BITS (0xFFFFF000)

//
// OMCR 4-11
//
#define OMCR_CRES_REG		    (0x1)
#define OMCR_CRES_1MSEC		    (0x2)
#define OMCR_CRES_1USEC		    (0x4)
#define OMCR_CRES_1SEC			(0x3)
...
#define OMCR_RESERVED_BITS		(0xFFFFFF00)
...
#define CKEN1_PWM3	(1 << 1)	/* PWM1 Clock Enable */
#define CKEN1_PWM2	(1 << 1)	/* PWM1 Clock Enable */
...
#define LCCR1_DisWdth(Pixel)            /* Display Width [1..800 pix.]  */               (((Pixel) - 1) << FShft (LCCR1_PPL))

#define LCCR1_HSW       Fld (6, 10)     /* Horizontal Synchronization     */
#define LCCR1_HorSnchWdth(Tpix)         /* Horizontal Synchronization  pulse Width [1..64 Tpix]       */      (((Tpix) - 1) << FShft (LCCR1_HSW))

#define LCCR1_ELW       Fld (8, 16)     /* End-of-Line pixel clock Wait    */
                                        /* count - 1 [Tpix]                */
#define LCCR1_EndLnDel(Tpix)            /*  End-of-Line Delay [1..256 Tpix]                  */                (((Tpix) - 1) << FShft (LCCR1_ELW))

#define LCCR1_BLW       Fld (8, 24)     /* Beginning-of-Line pixel clock   */
                                        /* Wait count - 1 [Tpix]           */
#define LCCR1_BegLnDel(Tpix)            /*  Beginning-of-Line Delay  [1..256 Tpix]                  */         (((Tpix) - 1) << FShft (LCCR1_BLW))


#define LCCR2_LPP       Fld (10, 0)     /* Line Per Panel - 1              */
#define LCCR2_DisHght(Line)             /*  Display Height [1..1024 lines] */                     (((Line) - 1) << FShft (LCCR2_LPP))

#define LCCR2_VSW       Fld (6, 10)     /* Vertical Synchronization pulse  */
                                        /* Width - 1 [Tln] (L_FCLK)        */
#define LCCR2_VrtSnchWdth(Tln)          /*  Vertical Synchronization pulse  Width [1..64 Tln]              */      (((Tln) - 1) << FShft (LCCR2_VSW))

#define LCCR2_EFW       Fld (8, 16)     /* End-of-Frame line clock Wait    */
                                        /* count [Tln]                     */
#define LCCR2_EndFrmDel(Tln)            /*  End-of-Frame Delay   [0..255 Tln]                   */                ((Tln) << FShft (LCCR2_EFW))

#define LCCR2_BFW       Fld (8, 24)     /* Beginning-of-Frame line clock   */
                                        /* Wait count [Tln]                */
#define LCCR2_BegFrmDel(Tln)            /*  Beginning-of-Frame Delay   [0..255 Tln]                   */         ((Tln) << FShft (LCCR2_BFW))
...
#define LCCR3_PixClkDiv(Div)            /* Pixel Clock Divisor */               (((Div) << FShft (LCCR3_PCD)))


#define LCCR3_BPP       Fld (3, 24)     /* Bit Per Pixel */
#define LCCR3_Bpp(Bpp)                  /* Bit Per Pixel */                     (((Bpp) << FShft (LCCR3_BPP)))

#define LCCR3_ACB       Fld (8, 8)      /* AC Bias */
#define LCCR3_Acb(Acb)                  /* BAC Bias */                        (((Acb) << FShft (LCCR3_ACB)))
